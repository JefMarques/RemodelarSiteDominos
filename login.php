...
<body style="background-color: #303030;">
    ...
    <main class="login">
        ...
        <form action="" method="POST">
            ...
            <a id= "criaConta" href="registro.html">Não possui cadastro? Crie sua conta aqui</a>
        </form>
...
if(isset($_POST['email']) || isset($_POST['senha'])) {
    ...
    if(strlen($_POST['email']) == 0) {
        ...
        $sql_code = "SELECT * FROM usuarios2 WHERE email = '$email' AND senha = '$senha'";
        ...
        if($quantidade == 1) {
            ...
            <div class="alert">
                ...
                <strong>Falha ao logar! Email ou senha incorretos</strong>
            </div>
            <?php 
        }
    }       
